"""Multi-task hybrid model (shared encoder, two heads).

Usage:
    poetry run python pipeline/train_mt.py
"""
...
MODEL_DIR = "data/models/multi_task"
...
def main() -> None:
    ...
    # ── Walk-forward ─────────────────────────────────────────────
    print(f"\n{'=' * 60}")
    print("Multi-task walk-forward (shared encoder, two heads)")
    print(f"{'=' * 60}")
    ...
    # ── Train final multi-task model on all data ─────────────────
    print(f"\n{'=' * 60}")
    print("Training final multi-task model on all seasons")
    print(f"{'=' * 60}")
